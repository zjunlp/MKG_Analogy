...
from transformers.models.visual_bert import VisualBertConfig
...
class VisualBertSelfAttention(nn.Module):
    ...
    def forward(
        ...
        attention_scores = attention_scores / math.sqrt(self.attention_head_size)   # bsz, 12, (txt+img), 64
...
# Copied from transformers.models.bert.modeling_bert.BertOnlyMLMHead with Bert->VisualBert
...
class VisualBertModel(VisualBertPreTrainedModel):
    ...
    def forward(
        ...
        # sep_idx + len(img)
        img_length = visual_embeds.shape[1]
        sep_idx += img_length
